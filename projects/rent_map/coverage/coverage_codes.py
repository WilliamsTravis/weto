...
def get_counts(codes):
    ...
    with Client():
        ...
        counts["ncovered"] = da.count_nonzero(covered).compute()
        counts["ndevelopable"] = da.count_nonzero(developable).compute()
...
def developable_coverage(counts):
    ...
    total_coverage = counts["ncovered"] / counts["ndevelopable"]
